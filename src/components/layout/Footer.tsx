      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#software" className="text-gray-400 hover:text-white transition">
                  Software Development
                </Link>
              </li>
              <li>
                <Link href="#consultancy" className="text-gray-400 hover:text-white transition">
                  IT Consultancy
                </Link>
              </li>
              <li>
                <Link href="#seo" className="text-gray-400 hover:text-white transition">
                  SEO Optimization
                </Link>
              </li>
              <li>
                <Link href="#mobile" className="text-gray-400 hover:text-white transition">
                  Mobile App Development
                </Link>
              </li>
              <li>
                <Link href="#cloud" className="text-gray-400 hover:text-white transition">
                  Cloud Solutions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-400 mr-3 mt-0.5">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+971 58 250 16 00</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-400 mr-3">
                ...
                <span className="text-gray-400">hq@cloud22.ae</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} CLOUD22. All rights reserved.
          </p>
